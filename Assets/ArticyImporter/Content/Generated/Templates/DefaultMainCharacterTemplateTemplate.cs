...
namespace Articy.King_s_Courier.Templates
{
    ...
    public class DefaultMainCharacterTemplateTemplate : IArticyBaseObject, IPropertyProvider
    {
        ...
        public Articy.King_s_Courier.Features.DefaultExtendedCharacterFeatureFeature DefaultExtendedCharacterFeature
        {
            get
            {
        ...
        public Articy.King_s_Courier.Features.DefaultBasicCharacterFeatureFeature DefaultBasicCharacterFeature
        {
            get
            {
        ...
        {
            Articy.King_s_Courier.Templates.DefaultMainCharacterTemplateTemplate newClone = ((Articy.King_s_Courier.Templates.DefaultMainCharacterTemplateTemplate)(aClone));
            if ((DefaultExtendedCharacterFeature != null))
            {
                newClone.DefaultExtendedCharacterFeature = ((Articy.King_s_Courier.Features.DefaultExtendedCharacterFeatureFeature)(DefaultExtendedCharacterFeature.CloneObject(newClone, aFirstClassParent)));
            }
            if ((DefaultBasicCharacterFeature != null))
            {
                newClone.DefaultBasicCharacterFeature = ((Articy.King_s_Courier.Features.DefaultBasicCharacterFeatureFeature)(DefaultBasicCharacterFeature.CloneObject(newClone, aFirstClassParent)));
            }
        ...
        {
            Articy.King_s_Courier.Templates.DefaultMainCharacterTemplateTemplate clone = new Articy.King_s_Courier.Templates.DefaultMainCharacterTemplateTemplate();
