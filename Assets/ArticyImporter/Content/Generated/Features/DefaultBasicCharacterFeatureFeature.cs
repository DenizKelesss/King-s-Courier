...
namespace Articy.King_s_Courier.Features
{
    ...
    public class DefaultBasicCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.King_s_Courier.Features.DefaultBasicCharacterFeatureFeature newClone = ((Articy.King_s_Courier.Features.DefaultBasicCharacterFeatureFeature)(aClone));
            newClone.Age = Age;
            if ((mSpecies != null))
            {
        ...
        {
            Articy.King_s_Courier.Features.DefaultBasicCharacterFeatureFeature clone = new Articy.King_s_Courier.Features.DefaultBasicCharacterFeatureFeature();
