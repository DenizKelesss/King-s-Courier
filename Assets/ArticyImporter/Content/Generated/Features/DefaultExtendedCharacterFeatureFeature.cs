...
namespace Articy.King_s_Courier.Features
{
    ...
    public class DefaultExtendedCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.King_s_Courier.Features.DefaultExtendedCharacterFeatureFeature newClone = ((Articy.King_s_Courier.Features.DefaultExtendedCharacterFeatureFeature)(aClone));
            if ((mMotivation != null))
            {
        ...
        {
            Articy.King_s_Courier.Features.DefaultExtendedCharacterFeatureFeature clone = new Articy.King_s_Courier.Features.DefaultExtendedCharacterFeatureFeature();
